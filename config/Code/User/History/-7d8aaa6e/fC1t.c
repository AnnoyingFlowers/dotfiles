...
char *test_read_write() {
    ...
    mu_assert(RingBuffer_available_data(buffer) == sizeof(data),
              "Available data should still be sizeof(data) after overwriting");
    mu_assert(RingBuffer_available_space(buffer) == DEFAULT_LEN - sizeof(data),
              "Available space should still be DEFAULT_LEN - sizeof(data) "
              "after overwriting");
