...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(
    ...
    vlSelf->ledr =
        ((0xe000U & ((IData)(vlSelf->top__DOT__my_led__DOT__led) << 8U)) |
         ((0x1f00U &
           (((IData)(vlSelf->top__DOT__my_led__DOT__led) ^ (IData)(vlSelf->btn))
            << 8U)) |
          (IData)(vlSelf->sw)));
}
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(
    Vtop___024root* vlSelf) {
    if (false && vlSelf) {
    }  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    __Vdly__top__DOT__my_vga_ctrl__DOT__y_cnt =
        vlSelf->top__DOT__my_vga_ctrl__DOT__y_cnt;
    __Vdly__top__DOT__my_vga_ctrl__DOT__x_cnt =
        vlSelf->top__DOT__my_vga_ctrl__DOT__x_cnt;
    __Vdly__top__DOT__my_keyboard__DOT__ps2_clk_sync =
        ((6U &
          ((IData)(vlSelf->top__DOT__my_keyboard__DOT__ps2_clk_sync) << 1U)) |
        ...
        if ((0xaU == (IData)(vlSelf->top__DOT__my_keyboard__DOT__count))) {
            ...
            if (VL_LIKELY(
                ...
                vlSelf->top__DOT__my_keyboard__DOT__buffer =
                    (((~((IData)(1U)
                         << (IData)(vlSelf
                                        ->top__DOT__my_keyboard__DOT__count))) &
                      (IData)(vlSelf->top__DOT__my_keyboard__DOT__buffer)) |
                     (0x3ffU &
                      ((IData)(vlSelf
                                   ->top__DOT__my_keyboard__DOT____Vlvbound_h1a91ade8__0)
                       << (IData)(vlSelf->top__DOT__my_keyboard__DOT__count))));
            }
            __Vdly__top__DOT__my_keyboard__DOT__count =
                (0xfU & ((IData)(1U) +
    ...
    if (vlSelf->rst) {
        ...
        if ((0U == vlSelf->top__DOT__my_led__DOT__count)) {
            __Vdly__top__DOT__my_led__DOT__led =
                ((0xfeU & ((IData)(vlSelf->top__DOT__my_led__DOT__led) << 1U)) |
                 (1U & ((IData)(vlSelf->top__DOT__my_led__DOT__led) >> 7U)));
        }
        __Vdly__top__DOT__my_led__DOT__count =
            ((0x4c4b40U <= vlSelf->top__DOT__my_led__DOT__count)
                 ? 0U
                 : ((IData)(1U) + vlSelf->top__DOT__my_led__DOT__count));
        if ((0x4c4b40U == vlSelf->top__DOT__my_seg__DOT__count)) {
            __Vdly__top__DOT__my_seg__DOT__offset =
                (7U & ((IData)(1U) +
                       (IData)(vlSelf->top__DOT__my_seg__DOT__offset)));
            __Vdly__top__DOT__my_seg__DOT__count = 0U;
        } else {
    ...
    vlSelf->seg0 = (0xffU & (~vlSelf->top__DOT__my_seg__DOT__segs
                                  [vlSelf->top__DOT__my_seg__DOT__offset]));
    vlSelf->seg1 =
        (0xffU & (~vlSelf->top__DOT__my_seg__DOT__segs[(
                     7U & ((IData)(1U) +
                           (IData)(vlSelf->top__DOT__my_seg__DOT__offset)))]));
    vlSelf->seg2 =
        (0xffU & (~vlSelf->top__DOT__my_seg__DOT__segs[(
    ...
    vlSelf->seg7 =
        (0xffU & (~vlSelf->top__DOT__my_seg__DOT__segs[(
                     7U & ((IData)(7U) +
                           (IData)(vlSelf->top__DOT__my_seg__DOT__offset)))]));
    vlSelf->VGA_HSYNC =
        (0x60U < (IData)(vlSelf->top__DOT__my_vga_ctrl__DOT__x_cnt));
    top__DOT__my_vga_ctrl__DOT__h_valid =
        ((0x90U < (IData)(vlSelf->top__DOT__my_vga_ctrl__DOT__x_cnt)) &
         (0x310U >= (IData)(vlSelf->top__DOT__my_vga_ctrl__DOT__x_cnt)));
    vlSelf->VGA_VSYNC =
        (2U < (IData)(vlSelf->top__DOT__my_vga_ctrl__DOT__y_cnt));
    top__DOT__my_vga_ctrl__DOT__v_valid =
...
#endif
                VL_FATAL_MT(
                    "/home/louis/gits/ysyx/ysyx-workbench/nvboard/example/vsrc/"
                    "top.v",
                    1, "", "Input combinational region did not converge.");
            }
            vlSelf->__VicoIterCount = ((IData)(1U) + vlSelf->__VicoIterCount);
...
#endif
                    VL_FATAL_MT(
                        "/home/louis/gits/ysyx/ysyx-workbench/nvboard/example/"
                        "vsrc/top.v",
                        1, "", "Active region did not converge.");
                }
                vlSelf->__VactIterCount =
                    ((IData)(1U) + vlSelf->__VactIterCount);
                __VpreTriggered.andNot(vlSelf->__VactTriggered,
