...
count:
	@echo 'all non-blank lines of *.h and *.c in nemu:'
	@bash -c 'find $NEMU_HOME -name '*.[ch]' | xargs cat | grep -v '^$' | wc -l'
	@echo 'all non-blank lines of *.h and *.c you have written in PA1:'
