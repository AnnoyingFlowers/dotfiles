...
char *test_copy() {
    ...
    while (src_node != NULL && dest_node != NULL) {
        ...
        printf("src_node->value: %s\n", (char *)src_node->value);
        printf("dest_node->value: %s\n", (char *)dest_node->value);
...
char *test_concat() {
    List_concat(dest, list);
    mu_assert(dest->count == 6, "Wrong count after concat.");
    printf("%s\n", (char *)List_first(dest));
    mu_assert(List_first(dest) == test1, "Wrong value on first after concat.");
    mu_assert(List_last(dest) == test3, "Wrong value on dest after concat.");
    mu_assert(list == NULL, "Wrong pointer after concat.");
...
char *test_split() {
    ...
    mu_assert(List_last(dest) == test3, "Wrong value on dest after split.");
    mu_assert(List_first(list) == test1, "Wrong value on list after split.");
